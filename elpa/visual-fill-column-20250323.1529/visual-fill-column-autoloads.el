...
This is a minor mode.  If called interactively, toggle the `Visual-Fill-
Column mode' mode.  If the prefix argument is positive, enable the mode,
...
Fill-Column mode' mode.  If the prefix argument is positive, enable the
