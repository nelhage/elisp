...

;;; Generated autoloads from mistty-accum.el

(register-definition-prefixes "mistty-accum" '("mistty--"))


;;; Generated autoloads from mistty-accum-macros.el

(register-definition-prefixes "mistty-accum-macros" '("mistty--accum-"))
