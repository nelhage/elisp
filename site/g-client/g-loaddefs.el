...
;;;***

;;;### (autoloads (gfeeds-titles) "gfeeds" "gfeeds.el" (18604 37687))
;;; Generated autoloads from gfeeds.el

(defsubst gfeeds-feed (feed-url) "\
Return feed structure." (declare (special gfeeds-feeds-url gfeeds-referer)) (let ((json-key-type (quote string)) (result nil)) (g-using-scratch (call-process g-curl-program nil t nil "-s" "-e" gfeeds-referer (format gfeeds-feeds-url (g-url-encode feed-url))) (goto-char (point-min)) (setq result (json-read)) (when (= 200 (g-json-get "responseStatus" result)) (g-json-lookup "responseData.feed" result)))))

(defsubst gfeeds-lookup (url) "\
Lookup feed for a given Web page." (declare (special gfeeds-lookup-url gfeeds-referer)) (let ((json-key-type (quote string)) (result nil)) (g-using-scratch (call-process g-curl-program nil t nil "-s" "-e" gfeeds-referer (format gfeeds-lookup-url (g-url-encode url))) (goto-char (point-min)) (setq result (json-read)) (when (= 200 (g-json-get "responseStatus" result)) (g-json-lookup "responseData.url" result)))))

(defsubst gfeeds-find (query) "\
Find feeds matching a query." (declare (special gfeeds-find-url gfeeds-referer)) (let ((json-key-type (quote string)) (result nil)) (g-using-scratch (call-process g-curl-program nil t nil "-s" "-e" gfeeds-referer (format gfeeds-find-url (g-url-encode query))) (goto-char (point-min)) (setq result (json-read)) (when (= 200 (g-json-get "responseStatus" result)) (g-json-lookup "responseData.entries" result)))))
...
;;;;;;  gfinance-portfolios) "gfinance" "gfinance.el" (18604 37687))
...
;;;;;;  greader-reading-list) "greader" "greader.el" (18604 37687))
...
;;;***

;;;### (autoloads (gsearch-google-at-point) "gsearch" "gsearch.el"
;;;;;;  (18604 37687))
;;; Generated autoloads from gsearch.el

(autoload 'gsearch-google-at-point "gsearch" "\
...
;;;;;;  gtube-user-profile) "gtube" "gtube.el" (18604 37687))
